...
const updateUserAvatar = async (req, res) => {
    try {
      ...
      console.log('Received avatar buffer:', avatar); // Логируем бинарные данные аватарки
      ...
      await user.save();
      console.log('User avatar updated:', user); // Логируем обновленного пользователя
  
      res.status(200).json({ message: 'Avatar updated successfully' });
    } catch (error) {
      console.error('Error updating avatar:', error); // Логируем ошибку, если она возникла
