...
router.get("/user-cards/:userId", authMiddleware, async (req, res) => {
    console.log("Запрос на '/user-cards/:userId' получен.");

    try {
        const { userId } = req.params; // Получаем ID пользователя из параметров URL
