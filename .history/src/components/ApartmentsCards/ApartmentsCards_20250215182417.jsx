...
function ApartmentsCards({ filters }) {
    ...
    const applyFilters = () => {
        return properties.filter(property => {
          const { price, propertySize, location, type, buildYear } = property;
          const { price: priceFilter, propertySize: sizeFilter, location: locationFilter, type: typeFilter, buildYear: yearFilter } = filterInputs;
