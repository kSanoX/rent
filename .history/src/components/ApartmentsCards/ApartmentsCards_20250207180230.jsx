                    ...
                    currentCards.map((card) => (
                        <div key={card._id} className="featured__item">
                            ...
                            <div className="featured__item-price">
                                <p>Price</p>
                                <span>{card.price}$</span> {/* заменил Pricing_Range на price */}
                                <button className="browse__properties-btn"><Link to={`/property-details/${card._id}`}>View Property Details</Link></button>
                            </div>
                        </div>
                    ))
                )}
