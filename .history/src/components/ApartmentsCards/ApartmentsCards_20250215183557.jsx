    ...
    useEffect(() => {
        const applyFilters = () => {
            const filtered = apartmentCards.filter(card => {
                ...
                console.log("Price filter:", priceFilter, "Price in range:", priceInRange);
                ...
                console.log("Size filter:", sizeFilter, "Matches size:", sizeInRange);
                console.log("Location filter:", locationFilter, "Matches location:", locationMatches);
                console.log("Type filter:", typeFilter, "Matches type:", typeMatches);
                console.log("Year filter:", yearFilter, "Matches year:", yearMatches);
