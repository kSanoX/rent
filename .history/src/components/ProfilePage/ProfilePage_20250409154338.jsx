  ...
  useEffect(() => {
    ...
    const fetchFilters = async () => {
      try {
        ...
        console.log("Fetched data:", data); // Логирование для проверки структуры данных
    
        if (Array.isArray(data)) {
          const optionsOnly = {};
    
          data.forEach(filter => {
            console.log("Filter:", filter); // Логирование каждого фильтра
    
            // Проходим по каждому элементу options и собираем строку
            const formattedOptions = filter.options.map(option => {
              // Собираем строку, исключая пустые элементы
              return option.value ? option.value.join('') : null; 
          ...
          console.log("Only options:", optionsOnly); // Логирование результатов
        } else {
