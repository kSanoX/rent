...
const ProfilePage = () => {
  ...
  const handleSliderImageUpload = (e) => {
    ...
    console.log(files); // Логируем файлы, которые мы получаем
    setSliderImages((prevImages) => [...prevImages, ...files]); // обновляем состояние с текущими изображениями
  };
              ...
              {user?.role === "admin" && (
                <div className="admin-panel">
                  ...
                  <form onSubmit={handleAddApartment}>
                    ...
                    <div className="file-container">
                      <label className="custom-file-upload">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            const files = Array.from(e.target.files);
                            setSliderImages((prevImages) => [...prevImages, ...files]);  // исправленный вариант
                          }}
                        />
                    ...
                    {console.log(sliderImages)}  {/* Логирование sliderImages перед рендером */}
