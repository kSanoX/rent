                      ...
                      <div className="image-preview">
                        {editingApartment?.images?.map((image, index) => (
                          <div key={index} className="image-container">
                            <img src={image} alt={`Apartment ${index + 1}`} className="preview-image" />
                        ...
                        <div className="file-container">
                          ...
                          {image && (
                            <div className="preview-container">
                              ...
                              <img src={URL.createObjectURL(image)} onChange={(e) => setEditingApartment(prev => ({ ...prev, image: e.target.value }))} alt="Cover" className="preview-image" />
